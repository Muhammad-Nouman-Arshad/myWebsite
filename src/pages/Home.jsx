    ...
    <div>
      ...
      <section className="bg-gray-100 py-10 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <button
            className="bg-blue-600 text-white py-2 px-4 md:py-2 md:px-6 text-sm md:text-base rounded-lg hover:bg-blue-700 cursor-pointer"
      ...
      <section className="bg-blue-600 py-10 md:py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <button
            className="bg-white text-blue-600 py-2 px-4 md:py-2 md:px-6 text-sm md:text-base rounded-lg hover:bg-gray-300 cursor-pointer"
            onClick={handleShopNowClick}
          >
            View Offers
          </button>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <img src={fe01} alt="Product 1" className="w-full h-48 object-cover" />
              <div className="p-4">
            ...
            {/* Product Card */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <img src={fe02} alt="Product 2" className="w-full h-48 object-cover" />
              <div className="p-4">
            ...
            {/* Product Card */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <img src={fe03} alt="Product 3" className="w-full h-48 object-cover" />
              <div className="p-4">
            ...
            {/* Product Card */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <img src={fe04} alt="Product 4" className="w-full h-48 object-cover" />
              <div className="p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white shadow-lg rounded-lg p-4 md:p-6">
              ...
              <div className="text-right">
                <h4 className="text-md md:text-lg font-semibold text-center">John Doe</h4>
              </div>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-4 md:p-6">
              ...
              <div className="text-right">
                <h4 className="text-md md:text-lg font-semibold text-center">Jane Smith</h4>
              </div>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-4 md:p-6">
              ...
              <div className="text-right">
                <h4 className="text-md md:text-lg font-semibold text-center">Alex Johnson</h4>
              </div>
            </div>
          </div>
        </div>
